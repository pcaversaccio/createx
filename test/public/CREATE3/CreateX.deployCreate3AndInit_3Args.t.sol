...
contract CreateX_DeployCreate3AndInit_3Args_Public_Test is BaseTest {
    /*´:°•.°+.*•´.*:˚.°*.˚•´.°:°•.°•.*•´.*:˚.°*.˚•´.°:°•.°+.*•´.*:*/
    /*                      HELPER VARIABLES                      */
    /*.•°:°.´+˚.*°.˚:*.´•*.+°.•°:´*.´•*.•°.•°:°.´:•˚°.*°.˚:*.´+°.•*/
        ...
        whenTheRefundTransactionIsSuccessful
    {
        ...
        assertEq(originalDeployer.balance, cachedBalance + values.constructorAmount + values.initCallAmount, "800");
        ...
        // refund amount.
        assertEq(originalDeployer.balance, cachedBalance + values.constructorAmount + values.initCallAmount, "1800");
        ...
        // It returns the non-zero balance to the `msg.sender` address.
        assertEq(originalDeployer.balance, cachedBalance + values.constructorAmount + values.initCallAmount, "2900");
